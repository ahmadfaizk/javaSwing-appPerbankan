 ...
 */
public class PanelListNasabah extends javax.swing.JPanel {

    /**
     * Creates new form PanelDashboard
     */
    public PanelListNasabah() {
        initComponents();
        update();
    }
    
    public void update() {
        WebAdminController.getInstance().updateTabelNasabah(tabelNasabah);
    }
